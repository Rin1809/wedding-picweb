...
import AIGuestbookHelper from './components/AIGuestbookHelper';
    ...
    <div className="min-h-screen font-sans selection:bg-wedding-gold selection:text-white">
          ...
          <div className="hidden md:flex gap-8">
            {NAV_LINKS.map(link => (
              <a 
                key={link.href} 
                href={link.href}
                className={`font-serif text-sm uppercase tracking-widest hover:text-wedding-gold transition-colors ${
      ...
      <main>
        ...
        <div className="relative">
          <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-wedding-gold/30 to-transparent" />
          <AIGuestbookHelper />
        </div>
      </main>
